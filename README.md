...
- **CI bootstrap workflow**: `bootstrap-service-ci` ([.github/workflows/bootstrap-service-ci.yml](.github/workflows/bootstrap-service-ci.yml)) delivers CI straight into a developer's own service repository — it pushes a `devops-ci` branch containing the golden-path CI workflow, ready for the developer to review and merge. See [docs/bootstrap-workflow-guide.md](docs/bootstrap-workflow-guide.md).
